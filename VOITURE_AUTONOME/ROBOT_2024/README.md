...
<p><span>Les prix sont donnés à titre informatif en fonction de ceux pratiqués sur AliExpress au 01/24</span>
  <ul>
    ...
    <li>1x Module de programmation ESP-01 - env. 3.5€</li>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:9'>
  ...
  <p style="text-align:center;">Le potentiomètre du capteur de vibration est réglée au minimum.<br/>Parfois, une valeur élevée fait que l'agent perçoit un choc qui n'a pas eu lieu.</p>
