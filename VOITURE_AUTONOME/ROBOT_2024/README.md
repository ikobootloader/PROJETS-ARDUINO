...
<ul>
 ...
 <li>L'algorithme d'évitement d'obstacles enregistrés en mémoire ne fonctionne pas correctement lorsque la position y ou x est à 0.</li>
</ul>
...
<p><span>Les prix sont donnés à titre informatif en fonction de ceux pratiqués sur AliExpress au 01/24</span>
  <ul>
    ...
    <li>1x Module de programmation ESP-01 - env. 3.5€</li>
   	<li>2x Panneaux solaire 0.15w 5v - env. 5€</li>
